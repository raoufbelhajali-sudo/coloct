...
// Petit rappel affiché à l'ouverture du blog (côté chercheur ET annonceur) :
// il est interdit d'y publier des annonces ou des coordonnées (email /
// téléphone), pour respecter le règlement et les données personnelles.
...
export default function AvertissementCoordonnees() {
  ...
  return (
    ...
    >
      <div className="pointer-events-auto flex w-full max-w-md items-start gap-2 rounded-2xl bg-ink/95 px-3.5 py-2.5 text-white shadow-xl backdrop-blur">
        ...
        <p className="flex-1 text-[12px] font-medium leading-snug">
          ...
          de publier des annonces, une adresse e-mail ou un numéro de téléphone.
        </p>
        <button
