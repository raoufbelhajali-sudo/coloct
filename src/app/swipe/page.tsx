...
export default function SwipePage() {
  ...
  // Fond dégradé bleu → turquoise : uniquement sur PC web (souris + pas l'app
  // native). Il apparaît dans les marges autour de la carte centrée.
  ...
  return (
    <main
      className={
        "relative flex h-dvh flex-col items-center overflow-hidden px-0 pb-16 pt-2 sm:px-4" +
        (fondPc ? " bg-signature" : "")
      }
    >
      <AppHeader />
