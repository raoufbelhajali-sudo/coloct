...
export default function SwipePage() {
  ...
  // Fond « carte » : uniquement sur PC web (souris + pas l'app native). Il
  // apparaît dans les marges autour de la carte, opacité réduite.
  ...
  return (
    <main className="relative flex h-dvh flex-col items-center overflow-hidden px-0 pb-16 pt-2 sm:px-4">
      {/* Fond carte (PC web uniquement), opacité réduite, derrière la carte */}
      {fondPc && (
        <div
          aria-hidden
          className="pointer-events-none absolute inset-0 z-0 bg-cover bg-center opacity-50"
          style={{ backgroundImage: "url(/fond-map.svg)" }}
        />
      )}
      ...
      <div className="relative z-10 flex w-full min-h-0 flex-1 justify-center">
        <SwipeDeck />
      </div>
